...
public class VerifyEmail extends HttpServlet {
    ...
    private final String WRONG="verifyEmail.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check=dao.checkCode(email, txtCode);
            if(check==true){
                dao.setActive(user);
                url=SUCCESS;
            }else{
                request.setAttribute("WRONG_CODE", "Wrong code, please input correct code !!");
                url=WRONG;
            }
        }catch(Exception e){
